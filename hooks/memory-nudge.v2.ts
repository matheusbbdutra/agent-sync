...
// Lembrete pos-ferramenta: a cada N chamadas nesta sessao, cobra a
...
// - Injecao via ctx.session.hook("context", ...) antes da proxima chamada
//   de modelo (substitui a limitacao v1 #13574).

const STORAGE_KEY_PREFIX = "agent-sync/memory-nudge/count"

const NOTE =
  "[agent-sync] Aconteceu algo nesta sessao que deveria virar memoria " +
  "(correcao do usuario, decisao de projeto, preferencia confirmada)? " +
  "Se sim, grave um resumo com o porque via store_memory (memory-mcp)."
