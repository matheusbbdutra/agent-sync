...
- **Hipótese ≠ fato:** pode formular hipótese (“acredito que X”), mas ela **não** vira conclusão sem validação. Toda hipótese ativa precisa de plano no mesmo turno: (a) você executa a verificação (tool/comando/leitura), ou (b) pede ao usuário o passo concreto que só ele pode fazer — e **para** até ter o resultado. Não implemente nem empilhe próximos passos só com base em hipótese não validada.
