...
description: "Use when proposing or reviewing significant architectural decisions (lib selection, schema, communication patterns, service boundaries). Avaliação arquitetural de backend focada em limites de contexto, desacoplamento e escalabilidade. patterns, clean architecture, microservices, event-driven systems, and DDD. Reviews system designs and code changes for architectural integrity, scalability, and maintainability. Use PROACTIVELY for architectural decisions."
---
