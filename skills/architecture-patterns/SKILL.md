...
description: "Use when designing a new backend service or refactoring boundaries in an existing one. Padrões arquiteturais para backend incluindo Clean Architecture, Hexagonal e microsserviços."
---
