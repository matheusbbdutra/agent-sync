...
description: "Use when implementing authentication or authorization (JWT, OAuth2, RBAC, ABAC, sessions). Padrões de autenticação e autorização (JWT, OAuth2, RBAC/ABAC e sessões seguras)."
---
