...
description: Context window strategy with sliding window (last K tool calls) + incremental summary generated by the session's own model. Implements the pattern from arXiv 2606.10209v1 (Microsoft, Lodha et al.) — 91.6% completion vs 71% with full context. Use at the start of, or to reanchor, a long session, or when the context window approaches its limit.
---
