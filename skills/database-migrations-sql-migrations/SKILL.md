...
description: "Use when writing schema migrations for PostgreSQL, MySQL, or SQL Server with zero-downtime. SQL database migrations with zero-downtime strategies for PostgreSQL, MySQL, SQL Server"
