...
description: "Use when debugging bugs, performance issues, or unexpected behavior that resists the first hypothesis. Técnicas sistemáticas de depuração, análise de causa raiz e reprodução de falhas."
---
