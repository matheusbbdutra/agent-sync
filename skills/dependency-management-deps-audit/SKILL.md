...
description: "Use when auditing dependencies for CVEs or planning a safe version upgrade. Auditoria e atualização segura de dependências, identificando vulnerabilidades (CVEs)."
---
