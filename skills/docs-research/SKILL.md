---
name: docs-research
description: "Use when researching official documentation for a library/framework/API with low token cost. Pesquisa eficiente em documentações oficiais com baixo consumo de tokens."
---
