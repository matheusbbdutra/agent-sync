---
name: javascript-pro
description: "Use when writing modern JavaScript (ES6+) with promises, async patterns, or Node.js APIs. JavaScript moderno (ES6+), padrões assíncronos, Node.js e gerenciamento de concorrência. APIs. Handles promises, event loops, and browser/Node compatibility. Use PROACTIVELY for JavaScript optimization, async debugging, or complex JS patterns."
---
