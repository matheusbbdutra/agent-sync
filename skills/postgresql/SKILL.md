---
name: postgresql
description: "Use when designing PostgreSQL schemas, indexes, constraints, or advanced features (JSONB, FTS, partitioning). Design a PostgreSQL-specific schema. Covers best-practices, data types, indexing, constraints, performance patterns, and advanced features"
---
