---
name: symfony
description: "Use when developing with Symfony (PHP 8+): HttpKernel, services, dependency injection, CLI commands. Desenvolvimento com framework Symfony (PHP 8+): HttpKernel, services, injeção de dependência e CLI."
---
